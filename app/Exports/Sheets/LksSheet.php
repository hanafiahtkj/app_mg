...
class LksSheet implements FromView, WithEvents, ShouldAutoSize, WithTitle
{
    ...
    public function view(): View
    {
        ...
        // echo view('excel.lks', $data); die;
        return view('excel.lks', $data);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $cellRange = 'A1:F'.$this->rowCount;
                $event->sheet->getDelegate()->getStyle($cellRange)
                    ->getAlignment()->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER)
                    ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);

                $event->sheet->getStyle('A4:F'.$this->rowCount)->applyFromArray([
                    'borders' => [
                        'allBorders' => [
