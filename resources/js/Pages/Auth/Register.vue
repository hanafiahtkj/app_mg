                            ...
                            <div class="card-body pb-2">
                                ...
                                <div class="form-group basic">
                                    <div class="input-wrapper">
                                        ...
                                        <input type="text" class="form-control" placeholder="Kode Referal" v-model="form.referral_code">
                                        <i class="clear-input">
                                            <ion-icon name="close-circle"></ion-icon>
                                        </i>
                                    </div>
                                ...
                                <div class="transparent mt-4">
                                    <button type="submit" class="btn btn-warning btn-block" :disabled="form.processing">Register</button>
                                </div>
