...
<template>
    ...
    <GuestLayout>
        ...
        <div class="appHeader text-light">
            <div class="left">
                <img
                    :src="route('index') + '/assets/img/logo.png'"
                    alt="logo"
                    class="logo"
                ...
                <div class="row mt-2">
                    <div class="col-6">
                        <div class="stat-box pb-4">
                            ...
                            <div class="value text-success mb-1">
                    ...
                    <div class="col-6">
                        <div class="stat-box pb-4">
                            ...
                            <div class="value text-danger mb-1">
                ...
                <div class="row mt-2">
                    <div class="col-6">
                        ...
                        <div class="stat-box pb-5">
                            <div class="title">Level</div>
                            <div class="value" :style="{ color: level.color }">
                                {{ level.name }}
                            </div>
                            <!-- <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a> -->
                        </div>
                ...
                <div class="transactions">
                    ...
                    <a v-for="coin in coinsMarkets" :key="coin.id" class="item">
                        ...
                        <div class="text-white text-end" style="min-width: 30%">
                            <strong>{{
                                formatCurrencyCoin(coin.current_price)
                            }}</strong>
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body p-0">
                        ...
                        <ul
                            class="listview flush transparent no-line image-listview"
                        >
                            <li>
                        ...
                        <ul
                            class="listview image-listview flush transparent no-line"
                        >
                            <li>
                                <a href="#" class="item">
                                    <img
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="action-sheet-content text-center">
                            ...
                            <div>
                                Tap
                                <ion-icon name="share-outline"></ion-icon> and
                                Add to homescreen.
                            </div>
                            <div class="mt-2">
                                <button
