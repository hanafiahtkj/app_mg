...
onMounted(() => {
    ...
    paymentConfirmationActionSheet = new bootstrap.Modal(
        document.getElementById("paymentConfirmationActionSheet")
    );
});
</script>
    ...
    <GuestLayout>
        ...
        <div id="appCapsule" class="full-height">
            <div class="section mt-2 mb-2">
                ...
                <ul
                    class="listview flush transparent simple-listview no-space mt-3"
                >
                    <li>
                    ...
                    <li>
                        ...
                        <h3 class="m-0">
                            {{ formatCurrency(transaction.amount_float) }}
                        </h3>
                    </li>
                    <template v-if="transaction.meta.txhash">
                        <li>
            ...
            <template
                v-if="
                    ...
                    transaction.meta.description == 'Deposit' &&
                    !transaction.meta.txhash
                "
            >
                <div class="section mb-4">
                    <div class="splash-page mt-5 mb-5">
                        <h4 class="mb-3">
                            Make the payment through the wallet ID below, USDT
                            (BEP20)
                        </h4>
                        ...
                        <p>
                            If you have already made the payment, please click
                            the Payment Confirmation button below.
                        </p>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <a
                                ...
                                data-bs-target="#paymentConfirmationActionSheet"
        ...
        <div
            ...
            id="paymentConfirmationActionSheet"
            tabindex="-1"
            role="dialog"
        >
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="action-sheet-content">
                            <form
                                @submit.prevent="submitPaymentConfirmation"
                                autocomplete="off"
                                novalidat
                            >
                                ...
                                <div class="form-group basic">
                                    <button
                                        ...
                                        :disabled="
                                            paymentConfirmation.processing
                                        "
                                    >
                                        Submit
                                    </button>
        ...
        <div id="toast-success" class="toast-box toast-center">
            <div class="in">
                <ion-icon
                    ...
                    class="text-success"
                ></ion-icon>
                <div class="text">Payment Confirmation Successful</div>
            </div>
        </div>
